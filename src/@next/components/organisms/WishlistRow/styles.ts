...
import { IWishlistRowType } from "./types";
...
const responsiveWrapper = css`
  ...
  `};
`;
export const Wrapper = styled.div<{ wishlistRowType: IWishlistRowType }>`
  display: grid;
  min-height: 140px;
  max-height: min-content;
  width: 100%;
  ${props =>
    props.wishlistRowType === "condense" ? condenseWrapper : responsiveWrapper}
  align-items: center;
...
`}
`;
export const Photo = styled.div<{ wishlistRowType: IWishlistRowType }>`
  grid-area: photo;
  display: flex;
  align-items: center;
  align-self: top;
  ...
  ${props =>
    props.wishlistRowType === "condense" ? condensePhoto : responsivePhoto}
...
`}
`;
export const Description = styled.div<{ wishlistRowType: IWishlistRowType }>`
  grid-area: description;
  height: 100%;
  ${props =>
    props.wishlistRowType === "condense"
      ? condenseDescription
...
const responsiveAttributes = css`
  ...
  `};
`;
export const Attributes = styled.div<{ wishlistRowType: IWishlistRowType }>`
  display: grid;
...
const responsivePrice = css`
  ...
  `};
`;
export const Price = styled.div<{ wishlistRowType: IWishlistRowType }>`
  font-size: ${props => props.theme.typography.h4FontSize};
  display: flex;
  justify-content: center;
  ${props =>
    props.wishlistRowType === "condense" ? condensePrice : responsivePrice}
...
const responsivePriceLabel = css`
  ...
  `};
`;
export const PriceLabel = styled.p<{ wishlistRowType: IWishlistRowType }>`
  ${props =>
    props.wishlistRowType === "condense"
      ? condensePriceLabel
...
const responsiveTotalPrice = css`
  ...
  `};
`;
export const TotalPrice = styled(Price)<{ wishlistRowType: IWishlistRowType }>`
...
const responsiveQuantity = css`
  ...
  `};
`;
export const Quantity = styled.div<{ wishlistRowType: IWishlistRowType }>`
  grid-area: quantity;
  min-width: 120px;
  ${props =>
    props.wishlistRowType === "condense"
